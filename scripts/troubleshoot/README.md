...
*	Create a support ticket in Azure : Please attach the TroubleshootErrorDump.txt generated by the troubleshooting script if you had tried running the script to solve your problem.
...
Create a support ticket in Azure and send this file alongwith it. We will respond back to you.

If steps above did not help to resolve your issue, you can use either of the following methods to contact us for help:
*	File a [GitHub Issue](https://github.com/microsoft/Docker-Provider/issues)
*	Create a support ticket in Azure : Please attach the TroubleshootErrorDump.log generated by the troubleshooting script if you had tried running the script to solve your problem.