...
if [ "${ARCH}" != "arm64" ]; then
    wget "https://github.com/microsoft/Docker-Provider/releases/download/testing%2Fmdsd%2F10062022/azure-mdsd_1.23.0-build.master.12_x86_64.deb" -O azure-mdsd.deb
else
