...
wget https://dl.influxdata.com/telegraf/releases/telegraf-1.25.1_linux_$ARCH.tar.gz
tar -zxvf telegraf-1.25.1_linux_$ARCH.tar.gz

mv /opt/telegraf-1.25.1/usr/bin/telegraf /opt/telegraf
