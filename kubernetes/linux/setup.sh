...
if [ "${ARCH}" != "arm64" ]; then
    wget "https://github.com/microsoft/Docker-Provider/releases/download/official%2Fmdsd%2F1.24.2/azure-mdsd_1.24.2-build.master.35_x86_64.deb" -O azure-mdsd.deb
else
    wget "https://github.com/microsoft/Docker-Provider/releases/download/official%2Fmdsd%2F1.24.2/azure-mdsd_1.24.2-build.master.35_aarch64.deb" -O azure-mdsd.deb
fi
