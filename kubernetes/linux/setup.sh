...
if [ "${ARCH}" != "arm64" ]; then
    wget "https://github.com/microsoft/Docker-Provider/releases/download/official%2Fmdsd%2F1.26.0/azure-mdsd-1.26.0-build.master.71.x86_64.rpm" -O azure-mdsd.rpm
else
    wget "https://github.com/microsoft/Docker-Provider/releases/download/official%2Fmdsd%2F1.26.0/azure-mdsd-1.26.0-build.master.71.aarch64.rpm" -O azure-mdsd.rpm
fi
