...
func (plug *containerInventoryPlugin) Init(ctx context.Context, fbit *plugin.Fluentbit) error {
...
func (plug containerInventoryPlugin) Collect(ctx context.Context, ch chan<- plugin.Message) error {
...
func (plug containerInventoryPlugin) enumerate() []map[string]interface{} {
