      ...
      begin
        ...
        @@winNodes.each do |winNode|
          ...
          begin
            ...
            containerGPUusageInsightsMetricsDataItems.concat(CAdvisorMetricsAPIClient.getInsightsMetrics(winNode: winNode, nameSpaces: @nameSpaces, metricTime: Time.now.utc.iso8601))
