...
class Constants
  ...
  EXTENSION_SETTINGS_DATA_COLLECTION_SETTINGS_NAMESPACES_MODE = "mode"
  EXTENSION_SETTINGS_DATA_COLLECTION_SETTINGS_NAMESPACES_FILTERING_MODES = ["off", "include", "exlcude"]
