...
##### Code change log
## What's Changed
 > Note: Default resource limits on the DaemonSet container have been increased: CPU limit has been raised from 500m to 3 cores, and memory limit has been increased from 750Mi to 2.5GB to support high log scale collection.
- Common
