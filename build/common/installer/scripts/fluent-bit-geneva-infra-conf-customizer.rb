...
def substituteFluentBitPlaceHolders
  begin
    ...
    ConfigParseErrorLogger.logError("fluent-bit-geneva-infra-conf-customizer: error while substituting values in fluent-bit-geneva-logs_infra.conf file: #{errorStr}")
  end
end
